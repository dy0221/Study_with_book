...
from Backpropagation.sigmoid_layer import Sigmoid
...
from Learning_skill.batch_normalization import BatchNormalization
from Learning_skill.dropout import Dropout
...
class MultiLayerNetExtend:
    ...
    def __init_weight(self, weight_init_std):
        ...
        for idx in range(1, len(all_size_list)):
            ...
            # lower를 쓰는이유 >> HE, He 등에 대한 입력의 확장성을 늘리기 위해
